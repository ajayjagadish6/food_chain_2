...
INSERT INTO "new_FoodDelivery" ("createdAt", "deliveryAddress", "deliveryTime", "donationId", "driverId", "id", "pickupAddress", "pickupTime", "requestId") SELECT "createdAt", "deliveryAddress", "deliveryTime", "donationId", "driverId", "id", "pickupAddress", "pickupTime", "requestId" FROM "FoodDelivery";
